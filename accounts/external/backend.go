...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain kyleX.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to kyleX-type signature.
		signature[64] -= 27 // Transform V from KyleX-legacy to 0/1
	}
