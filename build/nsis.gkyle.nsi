...
# 1. install gkyle for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gkyle
# 5. create gkyle, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable KYLEX_SOCKET
...
!define GROUPNAME "KyleX"
!define APPNAME "Gkyle"
!define DESCRIPTION "Official Go implementation of the KyleX protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gkyle is installed global
