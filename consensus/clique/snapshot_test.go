...
// mapped from textual names used in the tests below to actual KyleX private
...
// address retrieves the KyleX address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the KyleX address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/kyleX-network/go-kyleX/issues/17593). Whilst this
