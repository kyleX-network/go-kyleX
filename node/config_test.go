...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gkyle.ipc", false, filepath.Join(os.TempDir(), "gkyle.ipc")},
		{"data", "gkyle.ipc", false, "data/gkyle.ipc"},
		{"data", "./gkyle.ipc", false, "./gkyle.ipc"},
		{"data", "/gkyle.ipc", false, "/gkyle.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gkyle.ipc", true, `\\.\pipe\gkyle.ipc`},
		{"data", "gkyle.ipc", true, `\\.\pipe\gkyle.ipc`},
		{"data", `\\.\pipe\gkyle.ipc`, true, `\\.\pipe\gkyle.ipc`},
	}
