...
// Package bind generates KyleX contract Go bindings.
//
// Detailed usage document and tutorial available on the go-kyleX Wiki page:
// https://github.com/kyleX-network/go-kyleX/wiki/Native-DApps:-Go-bindings-to-KyleX-contracts
package bind
