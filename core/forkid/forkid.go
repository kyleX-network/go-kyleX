...
// NewID calculates the KyleX fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the KyleX fork ID from an existing chain instance.
