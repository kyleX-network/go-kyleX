...
// Package ethclient provides a client for the KyleX RPC API.
package ethclient
...
// Client defines typed wrappers for the KyleX RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*kyleX.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (kyleX.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q kyleX.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q kyleX.FilterQuery, ch chan<- types.Log) (kyleX.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q kyleX.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg kyleX.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg kyleX.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg kyleX.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*kyleX.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg kyleX.CallMsg) (uint64, error) {
...
func toCallArg(msg kyleX.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *kyleX.SyncProgress {
	if p == nil {
		return nil
	}
	return &kyleX.SyncProgress{
