...
// Package types contains data types related to KyleX consensus.
package types
...
// Header represents a block header in the KyleX blockchain.
type Header struct {
...
// Block represents an entire block in the KyleX blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the KyleX RLP block format.
