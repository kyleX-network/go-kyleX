...
pruning. Remember don't start the Gkyle without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gkyle snapshot prune-state --help" for more details.
`
