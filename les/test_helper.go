...
import (
	...
	"github.com/kyleX-network/go-kyleX/accounts/abi/bind/backends"
	...
	"github.com/kyleX-network/go-kyleX/contracts/checkpointoracle/contract"
	...
	"github.com/kyleX-network/go-kyleX/les/checkpointoracle"
	"github.com/kyleX-network/go-kyleX/les/flowcontrol"
	vfs "github.com/kyleX-network/go-kyleX/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some kyle to user1
		...
		case 1:
			...
			// bankUser transfers more kyle to user1
		...
		case 2:
			...
			// bankUser transfer some kyle to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
