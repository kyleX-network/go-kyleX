Name "gkyle ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/kyleX-network/go-kyleX/issues"
!define UPDATEURL "https://github.com/kyleX-network/go-kyleX/releases"
!define ABOUTURL "https://github.com/kyleX-network/go-kyleX#kyleX-go"
...
# Install gkyle binary
Section "Gkyle" GKYLE_IDX
  SetOutPath $INSTDIR
  file {{.Gkyle}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gkyle.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gkyle.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gkyle incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gkyle outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gkyle UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gkyle incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gkyle.exe" "" "" "KyleX" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gkyle outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gkyle.exe" "" "" "KyleX" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gkyle UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gkyle.exe" "" "" "KyleX" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "KYLEX_SOCKET" "R" "HKLM" "\\.\pipe\gkyle.ipc"
  ${EnvVarUpdate} $0 "KYLEX_SOCKET" "A" "HKLM" "\\.\pipe\gkyle.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GKYLE_IDX}
    SectionGetSize ${GKYLE_IDX} $0
