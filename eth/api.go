...
// KyleXAPI provides an API to access KyleX full node-related information.
type KyleXAPI struct {
	e *KyleX
}

// NewKyleXAPI creates a new KyleX protocol API for full nodes.
func NewKyleXAPI(e *KyleX) *KyleXAPI {
	return &KyleXAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *KyleXAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *KyleXAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *KyleXAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *KyleXAPI) Mining() bool {
...
func NewMinerAPI(e *KyleX) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of KyleX full node related APIs for node
// administration.
...
func NewAdminAPI(eth *KyleX) *AdminAPI {
...
// DebugAPI is the collection of KyleX full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *KyleX) *DebugAPI {
