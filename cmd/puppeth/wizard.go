...
type wizard struct {
	...
	services map[string][]string   // KyleX services known to be running on servers
...
// converts it to an KyleX address. If an empty line is entered, the default
// value is returned.
