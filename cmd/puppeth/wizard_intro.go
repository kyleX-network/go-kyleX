...
// setting up a new or managing an existing KyleX private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your KyleX private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new KyleX network down to  |")
	...
	log.Info("Administering KyleX network", "name", w.network)
