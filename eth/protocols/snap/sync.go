...
import (
	...
	"github.com/kyleX-network/go-kyleX/p2p/msgrate"
...
// Syncer is an KyleX account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the KyleX state over the
// snap protocol.
