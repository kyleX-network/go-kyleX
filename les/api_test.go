...
import (
	...
	ethdownloader "github.com/kyleX-network/go-kyleX/eth/downloader"
	...
	"github.com/kyleX-network/go-kyleX/p2p/simulations"
	"github.com/kyleX-network/go-kyleX/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	kyleX, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, kyleX, &config)
	if err != nil {
		return nil, err
	}
	return kyleX, nil
