...
import (
	...
	"github.com/kyleX-network/go-kyleX/internal/cmdtest"
	"github.com/kyleX-network/go-kyleX/rpc"
)

type testgkyle struct {
	*cmdtest.TestCmd
...
func init() {
	// Run the app if we've been exec'd as "gkyle-test" in runGkyle.
	reexec.Register("gkyle-test", func() {
...
// spawns gkyle with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGkyle(t *testing.T, args ...string) *testgkyle {
	tt := &testgkyle{}
	...
	// Boot "gkyle". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gkyle-test", args...)
