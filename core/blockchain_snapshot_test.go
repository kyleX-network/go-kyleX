...
// It can be used for testing that restart Gkyle normally.
...
// It can be used for testing that restart Gkyle after the crash.
...
// Tests a Gkyle restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gkyle was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gkyle was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gkyle was running with snapshot enabled. Then restarts without
...
// Tests the Gkyle was running with snapshot enabled and resetHead is applied.
...
// Tests the Gkyle was running with a complete snapshot and then imports a few
