// Copyright 2019 The go-kyleX Authors
...
// Package les implements the Light KyleX Subprotocol.
package les
...
import (
	...
	"github.com/kyleX-network/go-kyleX/common/mclock"
	...
	"github.com/kyleX-network/go-kyleX/les/downloader"
	"github.com/kyleX-network/go-kyleX/les/vflux"
	vfc "github.com/kyleX-network/go-kyleX/les/vflux/client"
	"github.com/kyleX-network/go-kyleX/light"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightKyleX, error) {
...
func (s *LightKyleX) VfluxRequest(n *enode.Node, reqs vflux.Requests) vflux.Replies {
	if !s.udpEnabled {
		return nil
	}
...
func (s *LightKyleX) vfxVersion(n *enode.Node) uint {
	if n.Seq() == 0 {
		var err error
		if !s.udpEnabled {
			return 0
...
func (s *LightKyleX) prenegQuery(n *enode.Node) int {
	if s.vfxVersion(n) < 1 {
...
// APIs returns the collection of RPC services the kyleX package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightKyleX) APIs() []rpc.API {
...
func (s *LightKyleX) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightKyleX) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightKyleX) TxPool() *light.TxPool              { return s.txPool }
func (s *LightKyleX) Engine() consensus.Engine           { return s.engine }
func (s *LightKyleX) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightKyleX) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightKyleX) EventMux() *event.TypeMux           { return s.eventMux }
func (s *LightKyleX) Merger() *consensus.Merger          { return s.merger }

// Protocols returns all the currently configured network protocols to start.
func (s *LightKyleX) Protocols() []p2p.Protocol {
...
// light kyleX protocol implementation.
func (s *LightKyleX) Start() error {
