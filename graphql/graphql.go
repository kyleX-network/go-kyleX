...
// Package graphql provides a GraphQL interface to KyleX node data.
package graphql
...
// Account represents an KyleX account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an KyleX transaction.
...
// Block represents an KyleX block.
...
type CallData struct {
	From                 *common.Address // The KyleX address the call is from.
	To                   *common.Address // The KyleX address the call is to.
