...
var (
	...
	KyleBlockReward     					= big.NewInt(7e+18) // Block reward in wei for successfully mining a block upward from Kyle
...
// rules of the stock KyleX ethash engine.
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	if config.IsKyle(header.Number) {
		blockReward = KyleBlockReward
	}
