...
import (
	...
	"github.com/kyleX-network/go-kyleX/internal/jsre"
	"github.com/kyleX-network/go-kyleX/internal/jsre/deps"
	"github.com/kyleX-network/go-kyleX/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute KyleX requests through
...
// Welcome show summary of current Gkyle instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gkyle JavaScript console!\n\n"

	// Print some generic Gkyle metadata
